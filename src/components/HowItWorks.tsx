  ...
  return (
    <section className="py-12 px-6 md:px-10 mb-16">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-4 text-connectu-blue">Your Virtual Clinic Experience</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-white border-connectu-blue border-t-4 shadow-md">
            <CardContent className="pt-6">
              <h3 className="text-xl font-semibold mb-3 text-connectu-blue">Holistic Patient Profiles</h3>
          ...
          <Card className="bg-white border-connectu-blue border-t-4 shadow-md">
            <CardContent className="pt-6">
              <h3 className="text-xl font-semibold mb-3 text-connectu-blue">Your Care, Enhanced</h3>
              <p className="text-gray-600">
          ...
          <Card className="bg-white border-connectu-blue border-t-4 shadow-md">
            <CardContent className="pt-6">
              <h3 className="text-xl font-semibold mb-3 text-connectu-blue">Seamless Specialist Network</h3>
              <p className="text-gray-600">
